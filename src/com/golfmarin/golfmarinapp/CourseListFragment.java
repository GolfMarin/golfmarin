...
/*      setListAdapter(new ArrayAdapter<County>(getActivity(),
                ...
                counties));
*/
        setListAdapter(new CourseArrayAdapter(getActivity(), R.layout.countylistitem));
	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		mCallbacks.onCourseSelected((Course) listView.getItemAtPosition(position));
	}
    ...
    public class CourseArrayAdapter extends ArrayAdapter<Course> {
    	...
    	private final int courselistitem;


    	public CourseArrayAdapter(Context context, int listitem) {
    		
    		super(context, listitem, courses);
    		this.context = context;
    		this.courselistitem = listitem;
...
//   	    }       
    	    ...
    	    if (courses != null) {
	    	    icon.setImageResource(getResources().getIdentifier(courses.get(position).thumbnailURL, 
	    	    			"drawable", "com.golfmarin.golfmarinmap"));

	    		line1.setText(courses.get(position).name);
	    		line2.setText(courses.get(position).city);
    	    }
